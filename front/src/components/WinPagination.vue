  ...
  <div class="win-pagination">
    ...
    >
      <svg viewBox="0 0 1024 1024" width="12" height="12">
        <path fill="currentColor" d="M672 192L384 512l288 320c12.8 14.4 12.8 36.8 0 51.2-14.4 12.8-36.8 12.8-51.2 0L304 537.6c-12.8-14.4-12.8-36.8 0-51.2l316.8-345.6c14.4-12.8 36.8-12.8 51.2 0 12.8 14.4 12.8 36.8 0 51.2z"/>
      </svg>
    </button>
    ...
    >
      <svg viewBox="0 0 1024 1024" width="12" height="12">
        <path fill="currentColor" d="M352 192l288 320-288 320c-12.8 14.4-12.8 36.8 0 51.2 14.4 12.8 36.8 12.8 51.2 0L720 537.6c12.8-14.4 12.8-36.8 0-51.2L403.2 140.8c-14.4-12.8-36.8-12.8-51.2 0-12.8 14.4-12.8 36.8 0 51.2z"/>
      </svg>
    </button>
