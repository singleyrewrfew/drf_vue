<template>
  <div class="win-pagination">
    ...
    <button class="win-pagination-btn" :disabled="currentPage === 1" @click="handlePrev">
    ...
    <button class="win-pagination-btn" :disabled="currentPage >= pageCount" @click="handleNext">
      <svg viewBox="0 0 1024 1024" width="12" height="12">
        <path
          fill="currentColor"
    ...
    <div class="win-pagination-sizes" v-if="showSizes">
      <WinSelect v-model="currentSize" :options="sizeOptions" @change="handleSizeChange" />
    </div>
  </div>
</template>
