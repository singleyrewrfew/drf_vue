<template>
  <nav v-if="hasNav" class="article-nav">
    <router-link v-if="prevArticle" :to="getArticleUrl(prevArticle)" class="nav-item prev">
    ...
    <router-link v-if="nextArticle" :to="getArticleUrl(nextArticle)" class="nav-item next">
      <div class="nav-content">
        <span class="nav-label">
          下一篇
