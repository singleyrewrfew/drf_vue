    ...
    <div class="comment-body">
      <div class="comment-main">
        ...
        <div class="comment-actions">
          <span class="action-btn" :class="{ liked: isLiked }" @click="handleLike">
      ...
      <div v-if="hasReplies" class="reply-section">
        <div class="reply-toggle" @click="handleToggleReplies">
          ...
          <div v-for="reply in comment.replies" :key="reply.id" class="reply-item">
            ...
            <div class="reply-body">
              ...
              <div class="reply-actions">
                ...
                <span class="action-btn small" @click.stop="handleReplyToReply(reply)">
                  <el-icon><ChatDotRound /></el-icon>
                  <span>回复</span>
                </span>
              </div>
