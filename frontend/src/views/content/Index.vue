        ...
        <el-card>
            ...
            <el-form :inline="true" :model="searchForm" class="search-form">
                <el-form-item label="状态">
                    <CustomSelect v-model="searchForm.status" :options="statusOptions" placeholder="全部"
                                  style="width: 120px"/>
                </el-form-item>
                <el-form-item label="分类">
                    <CustomSelect v-model="searchForm.category" :options="categories" label-key="name" value-key="id"
                                  placeholder="全部" style="width: 150px"/>
                </el-form-item>
                <el-form-item label="搜索">
                    <SearchInput v-model="searchForm.search" placeholder="标题搜索" @search="handleSearch"
                                 style="width: 220px"/>
                </el-form-item>
                <el-form-item>
